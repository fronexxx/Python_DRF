...
schema_view = get_schema_view(openapi.Info(title='About Pizza', default_version='v1', description='Pizza Shop', contact=openapi.Contact(email='admin@gmail.com')), public=True,
